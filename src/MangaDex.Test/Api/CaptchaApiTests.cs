...
namespace MangaDex.Test.Api
{
    ...
    public class CaptchaApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test PostCaptchaSolve
        /// </summary>
        [Fact]
        public void PostCaptchaSolveTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string contentType = null;
            //PostCaptchaSolveRequest postCaptchaSolveRequest = null;
            //var response = instance.PostCaptchaSolve(contentType, postCaptchaSolveRequest);
            //Assert.IsType<PostCaptchaSolve200Response>(response);
        }
    }
}
