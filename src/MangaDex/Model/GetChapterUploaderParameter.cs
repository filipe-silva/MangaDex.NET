...
namespace MangaDex.Model
{
    ...
    public partial class GetChapterUploaderParameter : AbstractOpenAPISchema, IEquatable<GetChapterUploaderParameter>, IValidatableObject
    {
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, GetChapterUploaderParameter.SerializerSettings);
        }
        ...
        public static GetChapterUploaderParameter FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    newGetChapterUploaderParameter = new GetChapterUploaderParameter(JsonConvert.DeserializeObject<Guid>(jsonString, GetChapterUploaderParameter.SerializerSettings));
                }
                else
                {
                    newGetChapterUploaderParameter = new GetChapterUploaderParameter(JsonConvert.DeserializeObject<Guid>(jsonString, GetChapterUploaderParameter.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newGetChapterUploaderParameter = new GetChapterUploaderParameter(JsonConvert.DeserializeObject<List<Guid>>(jsonString, GetChapterUploaderParameter.SerializerSettings));
                }
                else
                {
                    newGetChapterUploaderParameter = new GetChapterUploaderParameter(JsonConvert.DeserializeObject<List<Guid>>(jsonString, GetChapterUploaderParameter.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// </summary>
    public class GetChapterUploaderParameterJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(GetChapterUploaderParameter).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return GetChapterUploaderParameter.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
