...
namespace MangaDex.Model
{
    ...
    /// PutMangaIdRequest
    /// </summary>
    [DataContract(Name = "put_manga_id_request")]
    public partial class PutMangaIdRequest : IEquatable<PutMangaIdRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutMangaIdRequest {\n");
        ...
        {
            return this.Equals(input as PutMangaIdRequest);
        }

        /// <summary>
        /// Returns true if PutMangaIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutMangaIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutMangaIdRequest input)
        {
            if (input == null)
            {
                return false;
