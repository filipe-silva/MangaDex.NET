...
namespace MangaDex.Model
{
    ...
    /// MangaEdit
    /// </summary>
    [DataContract(Name = "MangaEdit")]
    public partial class MangaEdit : IEquatable<MangaEdit>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MangaEdit" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MangaEdit);
        }

        /// <summary>
        /// Returns true if MangaEdit instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaEdit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaEdit input)
        {
            if (input == null)
            {
                return false;
