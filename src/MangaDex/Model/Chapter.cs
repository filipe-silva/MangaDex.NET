...
namespace MangaDex.Model
{
    ...
    public partial class Chapter : IEquatable<Chapter>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public Chapter(Guid id = default(Guid), TypeEnum? type = default(TypeEnum?), ChapterAttributes attributes = default(ChapterAttributes), List<Relationship> relationships = default(List<Relationship>))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as Chapter);
        }

        /// <summary>
        /// Returns true if Chapter instances are equal
        /// </summary>
        /// <param name="input">Instance of Chapter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Chapter input)
        {
            if (input == null)
            {
                return false;
