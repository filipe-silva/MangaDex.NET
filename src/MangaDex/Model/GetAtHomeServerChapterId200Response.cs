...
namespace MangaDex.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_at_home_server_chapterId_200_response")]
    public partial class GetAtHomeServerChapterId200Response : IEquatable<GetAtHomeServerChapterId200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAtHomeServerChapterId200Response" /> class.
        /// </summary>
        /// <param name="result">result (default to &quot;ok&quot;).</param>
        /// <param name="baseUrl">The base URL to construct final image URLs from. The URL returned is valid for the requested chapter only, and for a duration of 15 minutes from the time of the response..</param>
        /// <param name="chapter">chapter.</param>
        public GetAtHomeServerChapterId200Response(string result = @"ok", string baseUrl = default(string), GetAtHomeServerChapterId200ResponseChapter chapter = default(GetAtHomeServerChapterId200ResponseChapter))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAtHomeServerChapterId200Response {\n");
        ...
        {
            return this.Equals(input as GetAtHomeServerChapterId200Response);
        }

        /// <summary>
        /// Returns true if GetAtHomeServerChapterId200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetAtHomeServerChapterId200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetAtHomeServerChapterId200Response input)
        {
            if (input == null)
            {
                return false;
