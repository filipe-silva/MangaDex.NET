...
namespace MangaDex.Model
{
    ...
    public partial class Manga : IEquatable<Manga>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public Manga(Guid id = default(Guid), TypeEnum? type = default(TypeEnum?), MangaAttributes attributes = default(MangaAttributes), List<Relationship> relationships = default(List<Relationship>))
        {
            this.Id = id;
            this.Type = type;
        ...
        {
            return this.Equals(input as Manga);
        }

        /// <summary>
        /// Returns true if Manga instances are equal
        /// </summary>
        /// <param name="input">Instance of Manga to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Manga input)
        {
            if (input == null)
            {
                return false;
