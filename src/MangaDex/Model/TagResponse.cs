...
namespace MangaDex.Model
{
    ...
    public partial class TagResponse : IEquatable<TagResponse>, IValidatableObject
    {
        ...
        public TagResponse(string result = @"ok", string response = @"collection", List<Tag> data = default(List<Tag>), int limit = default(int), int offset = default(int), int total = default(int))
        {
