...
namespace MangaDex.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_search_group_order_parameter")]
    public partial class GetSearchGroupOrderParameter : IEquatable<GetSearchGroupOrderParameter>, IValidatableObject
    {
        /// <summary>
        /// Defines Name
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSearchGroupOrderParameter" /> class.
        /// </summary>
        ...
        public GetSearchGroupOrderParameter(NameEnum? name = default(NameEnum?), CreatedAtEnum? createdAt = default(CreatedAtEnum?), UpdatedAtEnum? updatedAt = default(UpdatedAtEnum?), FollowedCountEnum? followedCount = default(FollowedCountEnum?), RelevanceEnum? relevance = default(RelevanceEnum?))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSearchGroupOrderParameter {\n");
        ...
        {
            return this.Equals(input as GetSearchGroupOrderParameter);
        }

        /// <summary>
        /// Returns true if GetSearchGroupOrderParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSearchGroupOrderParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSearchGroupOrderParameter input)
        {
            if (input == null)
            {
                return false;
