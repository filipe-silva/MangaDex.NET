...
namespace MangaDex.Model
{
    ...
    /// AuthorEdit
    /// </summary>
    [DataContract(Name = "AuthorEdit")]
    public partial class AuthorEdit : IEquatable<AuthorEdit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorEdit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthorEdit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorEdit" /> class.
        /// </summary>
        ...
        public AuthorEdit(string name = default(string), Dictionary<string, string> biography = default(Dictionary<string, string>), string twitter = default(string), string pixiv = default(string), string melonBook = default(string), string fanBox = default(string), string booth = default(string), string nicoVideo = default(string), string skeb = default(string), string fantia = default(string), string tumblr = default(string), string youtube = default(string), string weibo = default(string), string naver = default(string), string website = default(string), int varVersion = default(int))
        {
        ...
        {
            return this.Equals(input as AuthorEdit);
        }

        /// <summary>
        /// Returns true if AuthorEdit instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorEdit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorEdit input)
        {
            if (input == null)
            {
                return false;
