...
namespace MangaDex.Model
{
    ...
    public partial class UserList : IEquatable<UserList>, IValidatableObject
    {
        ...
        public UserList(string result = @"ok", string response = @"collection", List<User> data = default(List<User>), int limit = default(int), int offset = default(int), int total = default(int))
        {
