...
namespace MangaDex.Model
{
    ...
    public partial class Tag : IEquatable<Tag>, IValidatableObject
    {
        ...
        public Tag(Guid id = default(Guid), TypeEnum? type = default(TypeEnum?), TagAttributes attributes = default(TagAttributes), List<Relationship> relationships = default(List<Relationship>))
        {
            this.Id = id;
            this.Type = type;
