...
namespace MangaDex.Model
{
    ...
    /// ChapterRequest
    /// </summary>
    [DataContract(Name = "ChapterRequest")]
    public partial class ChapterRequest : IEquatable<ChapterRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChapterRequest" /> class.
        /// </summary>
        ...
        public ChapterRequest(string title = default(string), string volume = default(string), string chapter = default(string), string translatedLanguage = default(string), List<Guid> groups = default(List<Guid>), int varVersion = default(int))
        {
            this.Title = title;
            this.Volume = volume;
        ...
        {
            return this.Equals(input as ChapterRequest);
        }

        /// <summary>
        /// Returns true if ChapterRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ChapterRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChapterRequest input)
        {
            if (input == null)
            {
                return false;
