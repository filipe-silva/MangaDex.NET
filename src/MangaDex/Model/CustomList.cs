...
namespace MangaDex.Model
{
    ...
    public partial class CustomList : IEquatable<CustomList>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum CustomList for value: custom_list
            /// </summary>
        ...
        public CustomList(Guid id = default(Guid), TypeEnum? type = default(TypeEnum?), CustomListAttributes attributes = default(CustomListAttributes), List<Relationship> relationships = default(List<Relationship>))
        {
            this.Id = id;
            this.Type = type;
