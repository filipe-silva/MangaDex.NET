// GENERATED Refit scaffold for MangaApi — prototype, not wired into the build (needs Refit).
using System;
...
namespace MangaDex.Api
{
    ...
    {
        [Post("/manga/draft/{id}/commit")] [Headers("Content-Type: application/json")]
        ...
        [Post("/manga")] [Headers("Content-Type: application/json")]
