...
namespace MangaDex.Model
{
    ...
    /// </summary>
    [DataContract(Name = "get_search_manga_order_parameter")]
    public partial class GetSearchMangaOrderParameter : IEquatable<GetSearchMangaOrderParameter>, IValidatableObject
    {
        /// <summary>
        /// Defines Title
        /// </summary>
        ...
        public GetSearchMangaOrderParameter(TitleEnum? title = default(TitleEnum?), YearEnum? year = default(YearEnum?), CreatedAtEnum? createdAt = default(CreatedAtEnum?), UpdatedAtEnum? updatedAt = default(UpdatedAtEnum?), LatestUploadedChapterEnum? latestUploadedChapter = default(LatestUploadedChapterEnum?), FollowedCountEnum? followedCount = default(FollowedCountEnum?), RelevanceEnum? relevance = default(RelevanceEnum?), RatingEnum? rating = default(RatingEnum?))
        {
            this.Title = title;
            this.Year = year;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSearchMangaOrderParameter {\n");
        ...
        {
            return this.Equals(input as GetSearchMangaOrderParameter);
        }

        /// <summary>
        /// Returns true if GetSearchMangaOrderParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSearchMangaOrderParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSearchMangaOrderParameter input)
        {
            if (input == null)
            {
                return false;
