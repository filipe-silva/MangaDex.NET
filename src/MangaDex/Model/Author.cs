...
namespace MangaDex.Model
{
    ...
    public partial class Author : IEquatable<Author>, IValidatableObject
    {
        ...
        public Author(Guid id = default(Guid), TypeEnum? type = default(TypeEnum?), AuthorAttributes attributes = default(AuthorAttributes), List<Relationship> relationships = default(List<Relationship>))
        {
            this.Id = id;
            this.Type = type;
